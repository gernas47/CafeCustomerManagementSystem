...
public class ONBKPSPublicSoap
{
    ...
    public ONBKPSPublicSoap(){}

    public ONBKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public ONBKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        ONBExtendedSoapSerializationEnvelope envelope= new ONBExtendedSoapSerializationEnvelope(ONBExtendedSoapSerializationEnvelope.VER11);
