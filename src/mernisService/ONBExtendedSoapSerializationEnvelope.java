...
public class ONBExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(ONBDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new ONBStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static ONBDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static ONBDateTimeConverter dateTimeConverter = new ONBStandardDateTimeConverter();

    public ONBExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public ONBExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new ONBMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=ONBHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,ONBExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=ONBHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
